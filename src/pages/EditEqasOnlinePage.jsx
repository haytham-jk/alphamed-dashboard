...
export default function EditEqasOnlinePage() {
  ...
  return <div className="mx-auto max-w-3xl space-y-5">
    <Link to="/eqas-online" onClick={(event) => { if (!confirmDiscard()) event.preventDefault(); }} className="-ml-2 inline-flex items-center gap-2 rounded-xl px-2 py-1 text-slate-400 transition-colors hover:bg-slate-900/70 hover:text-white focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-400/70 focus-visible:ring-offset-2 focus-visible:ring-offset-slate-950"><ArrowLeft size={18} />Back to EQAS Online</Link>
