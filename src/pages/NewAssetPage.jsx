...
export default function NewAssetPage() {
  ...
  return (
    <div className="mx-auto max-w-3xl space-y-5">
      <Link to="/assets" className="-ml-2 inline-flex items-center gap-2 rounded-lg px-2 py-1 text-sm text-slate-400 hover:text-white focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-400">
        <ArrowLeft size={18} />
        Back to assets
      </Link>
      ...
      <form onSubmit={handleSubmit} className="grid grid-cols-1 gap-4 rounded-2xl border border-slate-800 bg-slate-900 p-5 md:grid-cols-2" onInvalidCapture={handleInvalidCapture}>
